...
//--------------------------------------------
  ...
  // memory stuff
  double precision = 1E-9;//= 0.0000001;
  int mDim = 0;
  double *M;
...
// everybody works until we are done
  while(maxnorm(x,c,mDim)>precision){
    ...
    /**
     * The following lines are only necessary if one wants to have intermediate 
     * solution files
     */
        // create intermediate solutions to look at evolution of solution vector.
//        if(id == 0 && (stepcounter%1000)==0){
// 	 // print to file
// 	
// 	string Result;
